export const verifyTemplate = (verifyUrl: string) => {
...
<div>
  ...
  <div>
    <p style="font-size:16px;margin-bottom:16px;line-height:24px">
      Cảm ơn bạn đã đăng ký Onesend.</p>
    <p style="font-size:16px;margin-bottom:16px;line-height:24px">
    ...
    <p style="font-size:16px;margin-bottom:16px;line-height:24px">
      <a href="${verifyUrl}" style="background:#0054de;color:#fff;font-size:14px;border:0;border-radius:4px;display:inline-block;line-height:24px;margin:8px 0;min-height:20px;outline:0;padding:8px 20px;text-align:center;vertical-align:middle;white-space:nowrap;text-decoration:none" target="_blank">Xác nhận địa chỉ email</a>
    </p>
    <p>
      Hoặc: 
